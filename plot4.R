...
png("plot4.png")
par(mfrow=c(2,2))
plot(x=(subepc$DateTime),y=subepc$Global_active_power,type="l",ylab="Global 
    Active Power (kilowatts)",xlab="")

plot(x=(subepc$DateTime),y=subepc$Voltage,type="l",ylab="Voltage",xlab=
    "datetime")

plot(x=(subepc$DateTime),y=subepc$Sub_metering_1,type="l",ylab="Energy sub 
    metering",xlab="")
...
plot(subepc$DateTime, subepc$Global_reactive_power, type = "l", main = "", xlab 
    = "datetime")
